"""
Django settings for demofitnessapp_47264 project.
...
ROOT_URLCONF = 'demofitnessapp_47264.urls'
...
WSGI_APPLICATION = 'demofitnessapp_47264.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "demofitnessapp_47264 API",
    "DESCRIPTION": "API documentation for demofitnessapp_47264 App",
    "VERSION": "v1",
}
